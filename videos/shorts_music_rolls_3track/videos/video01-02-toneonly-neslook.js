/*    video01-02-toneonly-neslook - form shorts_3track in videoground-samp-waveform
 *        
 */
VIDEO.resmode = 6;
//-------- ----------
...
VIDEO.init = function(sm, scene, camera){
    ...
    const URI_ROLL = videoAPI.pathJoin( sm.filePath, '../../../rolls/shorts_3track/nes_castlevania/cv_level01.txt' );
    ...
    ********** *********/
    ...
    sud.disp_points_0 = Samp_geodisp.create_line( { y: 3, linewidth: 10, for_vertcolor: (a) => { return [0.40 + 0.60 * a,0,0] } } );
    sud.disp_points_1 = Samp_geodisp.create_line( { y: 0, linewidth: 10, for_vertcolor: (a) => { return [0.40 + 0.60 * a,0,0] } } );
    sud.disp_points_2 = Samp_geodisp.create_line( { y:-3, linewidth: 10, for_vertcolor: (a) => { return [0.40 + 0.60 * a,0,0] } } );
    
    scene.add( sud.disp_points_0, sud.disp_points_1, sud.disp_points_2 );
    
    const create_disp_grid = () => {
    
        const grid = new THREE.GridHelper( 2, 2, 0xffffff, 0x808080);
