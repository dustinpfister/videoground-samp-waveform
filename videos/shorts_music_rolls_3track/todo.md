...
## ( ) ROLL: dark_seed_eightyone
    * (done) start the score
    * () 5+ measure tune.
    * () finish by 09/03
    
## ( ) ROLL: dark_seed_eightytwo
    * () start the score
    * () 5+ measure tune.
    * () finish by 09/04
    
## ( ) ROLL: dark_seed_eightythree
    * () start the score
    * () 5+ measure tune.
    * () finish by 09/05
    
## ( ) ROLL: dark_seed_eightyfour
    * () start the score
    * () 5+ measure tune.
    * () finish by 09/06
    
## ( ) ROLL: dark_seed_eightyfive
    * () start the score
    * () 5+ measure tune.
    * () finish by 09/07
...
## ( done 08/31/2024 ) ROLL: dark_seed_eighty
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 09/02

## ( done 08/30/2024 ) ROLL: dark_seed_seventynine
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 09/01

## ( done 08/29/2024 ) ROLL: dark_seed_seventyeight
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/29

## ( done 08/29/2024 ) ROLL: dark_seed_seventyseven
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/28

## ( done 08/28/2024 ) ROLL: dark_seed_seventysix
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/27

## ( done 08/27/2024 ) ROLL: dark_seed_seventyfive
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/26
...
## ( done 08/20/2024 ) ROLL: dark_seed_sixtynine
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/17
...
## ( done 08/15/2024 ) ROLL: dark_seed_sixtysix
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/15

## ( done 08/15/2024 ) ROLL: dark_seed_sixtyfive
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/14

## ( done 08/14/2024 ) ROLL: dark_seed_sixtyfour
    * (done) start the score
    * (done) 5+ measure tune.
...
## ( done 08/08/2024 ) ROLL: dark_seed_sixtyone
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/08
    
## ( done 08/08/2024 ) ROLL: dark_seed_sixty
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/08
      
## ( done 08/08/2024 ) ROLL: dark_seed_fiftynine
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/07
    
## ( done 08/07/2024 ) ROLL: dark_seed_fiftyeight
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/07 

## ( done 08/06/2024 ) ROLL: dark_seed_fiftyseven
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/06

## ( done 08/06/2024 ) ROLL: dark_seed_fiftysix
    * (done) start the score
    * (done) 5+ measure tune.
    * (done) finish by 08/06
...
## ( done 07/26/2024 ) ROLL: dark_seed_fifty
    * (done) start the score
    * (done) 5+ measure tune.
...
## ( done 07/24/2024 ) ROLL: dark_seed_fourtyeight
    * (done) start the score
    * (done) 5+ measure tune.
...
## ( done 07/14/2024 ) ROLL: dark_seed_thirtyeight
    * (done) start the score.
